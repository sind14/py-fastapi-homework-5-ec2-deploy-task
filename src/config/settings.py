...
class Settings(BaseAppSettings):
    ...
    SECRET_KEY_ACCESS: str = os.getenv("SECRET_KEY_ACCESS", binascii.hexlify(os.urandom(32)).decode())
    SECRET_KEY_REFRESH: str = os.getenv("SECRET_KEY_REFRESH", binascii.hexlify(os.urandom(32)).decode())
